...
function FirstSection() {
  ...
  const [products,setProducts] = useState([
    ...
    {'id':'9','name':'LIPSTICK','imgC':'/background/lipstickFinal.png','imgO':'/background/boxOpened.png',"bgC":"bg-[#B92211] rounded","textC":"text-[#B92211]",'color':'#B92211','content':`LIPSTICK is a flavor to relax and enjoy It is a flavor to relax and enjoy It is a flavor to relax and enjoyIt is a flavor to relax and enjoy It is a flavor to relax and enjoy It is a flavor to relax and enjoy. It is a flavor to relax and enjoy It is a flavor to relax and enjoy It is a flavor to relax and enjoy It is a flavor to relax and enjoy It is a flavor to relax and enjoy`}
  ])
